...
# I Customized it for MEC 2014 with slides (find more info about my script on www.msdigest.net)
...
$a = ([xml]$rss.downloadstring("http://channel9.msdn.com/Events/MEC/2014/RSS/mp4high")) 
$b = ([xml]$rss.downloadstring("http://channel9.msdn.com/Events/MEC/2014/RSS/slides")) 

#other qualities for the videos only. Choose the one you want!
# $a = ([xml]$rss.downloadstring("http://channel9.msdn.com/Events/MEC/2014/RSS/mp4")) 
#$a = ([xml]$rss.downloadstring("http://channel9.msdn.com/Events/MEC/2014/RSS/mp3")) 

#Preferably enter something not too long to not have filename problems! cut and paste them afterwards
$downloadlocation = "C:\MEC2014"
